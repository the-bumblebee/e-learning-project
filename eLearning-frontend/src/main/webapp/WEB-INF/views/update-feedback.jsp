...
<h1 class="text-center">Update Feedback</h1>
	<hr>
	<c:url var="updateUrl" value="/update-feedback" />
	<form:form action="${ updateUrl }" method="POST" modelAttribute="feedback" autocomplete="off">
		<div class="form-group row justify-content-md-center">
			<label class="col-sm-1">Feedback Id</label>
			<div class="col-sm-3">
				<form:input path="fId" cssClass="form-control" readonly="true"/>
			</div>
		</div>
		<div class="form-group row justify-content-md-center">
		...
		<div class="form-group row justify-content-md-center">
			...
			<a href="<c:url value='/feedback-list' />" class="btn btn-secondary">Back</a>
		</div>
	</form:form>
</body>
</html>